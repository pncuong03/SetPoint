      ...
      <div className="flex flex-col items-center justify-center mx-[126px] my-[100px]">
        <div className="flex flex-col items-center gap-[120px] lg:flex-row lg:items-start lg:justify-around mx-4 lg:mx-8 w-[100%] ">
          <div className="flex flex-col items-center gap-[30px] lg:items-start mt-[80px]">
            <h1 className=" text-30xl lg:text-12xl font-inter font-bold m-0 ">
            ...
            <p className="text-30xl lg:text-12xl font-inter font-normal m-0">
          ...
          <div className="lg:flex w-[120%] object-cover">
            <img
