export const Intro = () => {
  return (
    <section>
      <div className="flex flex-col items-center justify-center  mx-[120px] gap-[140px] lg:h-[700px]">
        ...
        <div className="lg:flex lg:w-[130%] object-cover ">
            <img
          ...
          <div className="flex flex-col items-center gap-[10px] lg:items-start mt-[13%] w-[120%]">
            <h1 className="text-31xl lg:text-29xl font-inter font-bold m-0 ">
            Treaty is a first Memecoin GameFi on Sui Network
            </h1>
            <p className="text-31xl lg:text-29xl font-inter font-normal m-0">
