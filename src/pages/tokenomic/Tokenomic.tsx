      ...
      <div className="">
        ...
        <div className="flex flex-col items-center gap-[120px] lg:flex-row lg:items-center lg:justify-around mt-28">
          <div className="flex flex-col gap-[20px] items-center text-center w-[350px] lg:items-start lg:w-[120%]">
            <h1 className="text-4xl lg:text-12xl xl:text-45xl lg:text-start font-inter font-bold m-0">
            Tokenomics
            </h1>
            <p className="text-4xl lg:text-12xl xl:text-45xl lg:text-start font-inter font-normal m-0">
