    ...
    <header className="py-4">
      <div className="flex flex-wrap lg:flex-nowrap items-center justify-between px-3 lg:px-24 xl:px-28">
        ...
        <img src="/LogoTreaty.svg" className="px-4 w-40 2xl:w-auto" alt="" />
          ...
          <FiMenu className="lg:hidden block h-8 w-6 cursor-pointer px-5" onClick={()=> setOpen(!open)}/>
            <nav className={`${ open ? "block" : "hidden"} w-full lg:flex lg:items-center lg:w-auto shadow-lg lg:shadow-none`}>
            <ul className="text-normal text-4xl xl:text-5xl lg:flex lg:justify-between lg:items-center list-none lg:px">
              ...
              <li>
                ...
                <button  className="xl:py-4 xl:px-4 py-2 bg-[#216BEB] font-inter text-4xl xl:text-5xl text-white rounded-[54px]">Buy $TRT</button>
                </div>
