export const Build = () => {
  return (
    <section data-layouts="multiple" data-background="darkGreen" className="section section-top section-bot contain-paint bg-darkGreen text-white space-y-6 md:space-y-8 pb-0 md:pb-12 section-contained">
      <div className="container">
        <div className="text-center mx-auto max-w-[900px]">
          <h3 className="mx-auto pt-1 text-center text-h2 mb-3 max-w-[460px]">Build a single source of truth.</h3>
          <div className="pt-2 mx-auto max-w-[595px]">
      ...
      <div className="container rounded-[2rem] px-0 py-8 md:py-8">
        <div className="w-full border-b border-fadedGrey pb-5 px-6 md:px-8 -mt-2 flex items-center space-x-4">
          <h4 className="p-large font-body font-bold text-xs">Setpoint Activity Feed
          </h4>
